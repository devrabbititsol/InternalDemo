package api.internaldemo.apidemo.apitestclasses;
...
import api.internaldemo.apidemo.apipageclasses.GoogleAPIGet2Dataset;
public class TC_GoogleAPI extends BaseClass {
	...
	public TC_GoogleAPI() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_GoogleAPI.class);
	...
	public void doRequest() throws Exception { 
		...
		String primaryInfo = GoogleAPIGet2Dataset.primaryInfo;
		Constants.PRIMARY_INFO = primaryInfo;
		reports = ExtentConfigurations.getExtentInstance(reportsPath, projectPath ,GoogleAPIGet2Dataset.projectName);
		test = reports.startTest("Verifying TC_GoogleAPI API");
		int datasetLength = GoogleAPIGet2Dataset.datasetLength; 
